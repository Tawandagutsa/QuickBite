...
class Fake {
  ...
  static List<Category> categories = [
    Category('assets/icons/snacks.png', 'Snacks'),
    Category('assets/icons/burger.png', 'Burgers'),
    Category('assets/icons/hot_dogs.png', 'Hotdogs'),
     Category('assets/icons/chicken.png', 'Rice and Chicken'),
  ];
