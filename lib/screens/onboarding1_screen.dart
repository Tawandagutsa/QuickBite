  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> data =[
...

        {
         ...
         {
          'title': 'Delivery',
          'desc': 'Just place an order and your food will be delivered to your location. .'
        },
         {
          'title': 'Promotions',
          'desc': 'Check your notifications for any promotions. You might get lucky.'
        },
    ];
    return Expanded(
...
class PageIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      width: pageCount ==index ?  getProportionateScreenWidth(32):
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 50, top: 18, ),
              child: Image.asset(
              ...
              padding: EdgeInsets.only(bottom: 8),
                ...
                child: SizedBox(
                  ...
                  child: PageView(
                    ...
                    children: [
                      Image.asset(
                      'assets/images/038-take-away.png',
                      scale: 2.7
                    ),
                    Image.asset(
                      'assets/images/031-delivery.png',
                      scale: 2.7
                    ),
                    Image.asset(
                      'assets/images/023-coupon.png',
                      scale: 2.7
                    ),
                    ]
                  ),
